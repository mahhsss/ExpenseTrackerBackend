//
//  GetRecentTranasctionDatabase.swift
...
public class GetRecentTransactionDatabase: TransactionDatabase {
    
    public override init() { }
}

extension GetRecentTransactionDatabase: GetRecentTransactionDatabaseContract {
